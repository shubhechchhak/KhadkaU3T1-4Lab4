...
public class MathGameUI {
    ...
    private void setup() {
        ...
        System.out.print("Enter a difficulty level (easy, hard): ");
        ...
        game = new MathGame(p1, p2, p3, level, scan);
    }
    ...
    private void mainMenu() {
        ...
        while (playAgain.equals("y")) {
            ...
            if (game.getWinner() != null) {  // check for null just to be safe (so we don't call a method on null)
                ...
                int streak = game.getWinningStreak();
                if (streak >= 2) {
                    System.out.println(game.getWinner().getName() + " has won " + game.getWinningStreak() + " games in a row!"); // print winner's streak
                }
            }
            System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
